...
int main(int argc, char const *argv[])
{
    ...
    //Patients
    Patient* patient1 = new Patient("Hňup Obecný");
    hospital->addPerson(patient1);
    Patient* patient2 = new Patient("Zlom Noha");
    hospital->addPerson(patient1);
    Patient* patient3 = new Patient("George Simp");
    hospital->addPerson(patient1);
    ...
    nurse1->workInAmbulance(5);
    nurse1->workInAmbulance(10);
